...
const skills = [
  ...
  },
  {
    ...
    description:
      'Execute a small plan or request as context-isolated subagent tasks sharing one writable workspace, tracked in a .xsk/runs/ ledger, with one confirmation gate, no per-task review, and unified acceptance. Explicit invocation only.',
    platforms: ALL_PLATFORMS.slice(),
