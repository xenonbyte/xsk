...
const skills = [
  ...
  },
  {
    ...
    description:
      'Orchestrate a small plan or request as serial context-isolated subagent tasks in a clean Git worktree, tracked in a compact .xsk/runs/ ledger, with one confirmation gate and unified acceptance at the end. Explicit invocation only.',
    platforms: ALL_PLATFORMS.slice(),
