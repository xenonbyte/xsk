...
const skills = [
  ...
  },
  {
    ...
    description:
      'Implement an active requirement or a think plan explicitly routed to xsk-execute-req, verify the result, and automatically archive on success. Inline think execution stays in normal conversation.',
    platforms: ALL_PLATFORMS.slice(),
    fragmentBase: 'execute-req',
  },
  {
