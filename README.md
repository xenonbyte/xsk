...
| `xsk-execute-plan` | Execute a small plan or request as context-isolated subagent tasks sharing one writable workspace, tracked in a `.xsk/runs/` ledger, with one confirmation gate and unified acceptance. Explicit invocation only. |
