...
## Tier Estimate
base: standard
modifiers: cross_project, scope_expanding

## Evidence Block
keywords_hit: ['c', 'r', 'project', 'repo', 'whole', 'full']
repo_baseline_summary: loc=4125, modules=5, monorepo=False, languages=['JavaScript']
linked_context: none
scope_signals: ['whole', 'full']
escalation_candidates: ['cross_project']
