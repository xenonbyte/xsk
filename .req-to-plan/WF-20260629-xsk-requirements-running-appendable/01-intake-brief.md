...
work_id: WF-20260629-xsk-requirements-running-appendable
requirement: # xsk Requirements
...
## Evidence Block
keywords_hit: ['rewrite', 'migration', 'migrating', 'go', 'c', 'r', 'project', 'repo', 'drop', 'live', 'order', 'full']
repo_baseline_summary: loc=5259, modules=5, monorepo=False, languages=['JavaScript']
linked_context: none
scope_signals: ['full']
escalation_candidates: ['migration', 'cross_project', 'safety']
