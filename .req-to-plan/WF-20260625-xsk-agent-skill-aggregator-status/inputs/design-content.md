...
## Options Considered
- Install safety: (A) manifest-backed owned-only removal vs (B) naive copy/overwrite with timestamp markers. Chose A — only A can prove "remove exactly what we created" and gate directory removal (RISK-SEC-001/002).
...
|---|---|---|
| DES-ARCH-001 | requirement_brief SCOPE-IN-002..005; risk RISK-SEC-001..003 | derived |
| DES-SEC-001 | requirement_brief SCOPE-IN-004, AC-002, AC-007; risk RISK-SEC-001..003 | derived |
...
| Rollback | requirement_brief AC-002; risk RISK-SEC-001 | derived |
| Observability | requirement_brief AC-007; risk RISK-TECH-001 | derived |
