...
work_id: WF-20260711-status-active-slug-xsk-execute
requirement: ---
status: active
...
## Evidence Block
keywords_hit: ['替代', '替换', 'go', '项目', '仓库', '删除', '集成', '调用', '依赖', '全部', '所有']
repo_baseline_summary: loc=6571, modules=5, monorepo=False, languages=['JavaScript']
linked_context: none
scope_signals: ['全部', '所有']
